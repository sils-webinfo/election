...
If you're working alone, please **rename your GitHub repository** to something more suitable for your service. You can do this by clicking on the ![admin](election/raw/master/doc/img/admin.png) button from your repository's page on GitHub. (If you're working in a group the repository will be named after your group).
